...
doc <- "Usage:
MeDEStrandBEDPE.r --inputFile <FILE> --outputDir <DIR> --windowSize <SIZE>
MeDEStrandBEDPE.r --inputFile=FILE --outputDir=DIR --windowSize=SIZE

--inputFile FILE     Aligned, sorted, filtered reads (bam) [default: ]
...
if(is.null(df_for_wig)){df.rms<-("#Error: MeDEStrand CpG density normalization failed due to small number of reads")}
